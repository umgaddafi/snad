    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-slate-50 py-10">
      <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Join Snad Kitchen to order premium meals</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-gray-900 hover:bg-gray-800 text-white font-bold py-4 rounded-xl transition flex justify-center items-center disabled:opacity-70 mt-4"
          >
